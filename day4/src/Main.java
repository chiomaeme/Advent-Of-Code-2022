    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (reader.hasNextLine()) {
                ...
                if ((part1num1 <= part2num1) && (part1num2 >= part2num2)) {
                    pairs++;
                    System.out.println("Part 1: " + part1 + " Part 2: " + part2);
                } else if ((part1num1 >= part2num1) && (part1num2 <= part2num2)) {
                    pairs++;
                    System.out.println("Part 1: " + part1 + " Part 2: " + part2);
                }
        ...
        System.out.println("The amount of fully contained pairs is: " + pairs);
    }
}